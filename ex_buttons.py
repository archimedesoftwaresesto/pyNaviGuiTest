...
(window.win_title('Test of inputs').win_size('900x600').move_to(30,80).
 ...
 button('Read values',font=('Arial',33), fg='#0000FF' , k=KEY_BTN_READ_VALUES).text('               ').
 button('Set focus on name',bg='yellow', fg='#00FF00', k=KEY_BTN_FOCUS_TO_NAME).
 button('Set focus on surname',font=('Arial',22), fg='red', bg='#883311', k=KEY_BTN_FOCUS_SURNAME)
 )
